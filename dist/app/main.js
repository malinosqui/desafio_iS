...
(0, _jquery2.default)(function () {
    ...
    (0, _jquery2.default)("#btnToggleClock").click(function ($ev) {
        //adiciona ou remove classe para esconder ou mostrar relógio
        (0, _jquery2.default)(".clock").toggleClass("hide");

        //booleano para troca de texto
        hide = !hide;

        //caso esteja escondido troca o texto para 'Mostrar relógio'
        if (hide) (0, _jquery2.default)("#btnToggleClock").html('Mostrar relógio');
        //caso esteja amostra troca o texto para 'Esconder relógio
        else (0, _jquery2.default)("#btnToggleClock").html('Esconder relógio');
    });
});
